...
public class MASimpleDraw extends JPanel implements Runnable {    
    ...
    private MADrawGraphics draw;

    
    public MASimpleDraw(MADrawGraphics drawer) {
        this.draw = drawer;
    }
    ...
    public static void main(String args[]) {
        final MASimpleDraw content = new MASimpleDraw(new MADrawGraphics());
